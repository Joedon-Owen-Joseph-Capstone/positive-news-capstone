export default function About() {
    return (
        <>
            <section className="py-18 text-black">
                ...
                <div className="md:flex gap-10 mx-auto max-md:space-y-12 p-16 flex-4">
                    <div className="basis-1/6 flex-shrink-0 justify-center max-md:px-16">
                        <img src="https://placekitten.com/g/500/500" alt="cat" height="500" width="500" className="shadow-2xl rounded-lg"/>
                    </div>
                    <div className="basis-5/6 max-md-8">
                        <h3 className="font-bold text-xl italic">Owner Name</h3>
                        <p className="md:py-2 mr-32 mt-10">Now that there is the Tec-9, a crappy spray gun from South Miami.
                        ...
                        <p className="md:py-2 mr-32"> the path of the righteous man is beset on all sides by the iniquities
                            of
