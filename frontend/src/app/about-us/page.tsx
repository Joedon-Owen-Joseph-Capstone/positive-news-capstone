                ...
                <div className="lg:flex gap-10 mx-auto max-md:space-y-12 p-6 lg:p-24 flex-4">
                    ...
                    <div className={"mt-20"}>
                        ...
                        <a href="mailto:odscarpa512@gmail.com"><p
                            className={"hover:text-purple-700 hover:underline"}>odscarpa512@gmail.com</p></a>
                    </div>
                </div>
            </section>
            ...
            <section id={"joedon"} className="py-18 my-20 bg-[#0e142a] text-white rounded-3xl">
                <div className="lg:flex gap-10 mx-auto max-md:space-y-12 p-6 lg:p-24 flex-4">
                    ...
                    <div className="basis-5/6 max-md-8">
                        <h3 className="font-bold text-xl italic text-center">Joedon Mconnell</h3>
                        <p className="md:py-2 mt-4">Now that there is the Tec-9, a crappy spray gun from South
                            Miami.
                            This gun is advertised as the most popular gun in American crime. Do you believe that shit?
                            It actually says that in the little book that comes with it:
                    ...
                    <div className={"mt-20"}>
                        <h4 className="font-bold italic">Contact Joedon</h4>
                        <div className={"flex gap-4 mx-auto"}>
                        ...
                        <a href="mailto:jdmconnell@gmail.com"><p
                            className={"hover:text-purple-700 hover:underline"}>jdmconnell@gmail.com</p></a>
                    </div>
                </div>
            </section>
        </section>
