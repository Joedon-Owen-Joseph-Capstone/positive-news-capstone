...
export default function Profile() : JSX.Element {
    return(
        <>
            <section className='block lg:flex items-center gap-16 border-b-4 border-black p-12 md:p-24'>
                <img className='h-60 w-60 rounded-full border-black border-4' src='' alt='profile image'/>
                <div className='pt-5 lg:pt-0'>
                    ...
                    <p className='text-black text-6xl text-right'>. . .</p>
                </div>
            </section>
            ...
            <section className='my-24'>
                <div className="container mx-auto">
                    <div className='flex justify-between'>
                        <h2 className='text-black text-3xl md:text-4xl lg:text-5xl'>Saved Articles</h2>
